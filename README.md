# 20 PHP Projects for Beginners from easy to hard

|                                     Project No.                                      |                                                          Project Name                                                           | Video Explanation |                                           Live Demo                                           |
| :----------------------------------------------------------------------------------: | :-----------------------------------------------------------------------------------------------------------------------------: | :---------------: | :-------------------------------------------------------------------------------------------: |
|                                        [01]()                                        |                                                    [Simple CRUD Operation]()                                                    |     Watch Now     |                                         [Live Demo]()                                         |
...
# 01. Simple CRUD Operations

### Difficulty: Easy(2/10)

### You Will Learn

- কিভাবে PHP দিয়ে CRUD Operations অর্থাৎ Database থেকে Information Create, Read, Update এবং Delete করা যায়। 
- MySQL Procedural Programming Approach.

### Project Description

এটি একটি Simple Form Project যার Front-end এ HTML, CSS এবং Bootstrap ব্যবহার করা হয়েছে। এবং Backend এ PHP ব্যবহার করা হয়েছে। মূলত কিভাবে CRUD Operation করতে হয় সেটিই এই প্রোজেক্টে দেখানো হয়েছে। 

### Project Requirements

- User Registraion করতে পারবে। 
- Database থেকে Data Create, Read, Update এবং Delete করতে হবে। 
- Edit Button এ প্রেস করলে নতুন একটা পেইজে না গিয়ে বরং Same Page এই Edit করার জন্য Pop-up Window আসবে। 
